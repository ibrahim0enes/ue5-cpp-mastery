...
struct Z_Construct_UClass_ABattleBlasterGameMode_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ScreenMesaageClass_MetaData[] = {
...
#endif // WITH_METADATA
	static const UECodeGen_Private::FClassPropertyParams NewProp_ScreenMesaageClass;
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_ABattleBlasterGameMode_Statics::NewProp_ScreenMesaageClass = { "ScreenMesaageClass", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ABattleBlasterGameMode, ScreenMesaageClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UScreenMessage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ScreenMesaageClass_MetaData), NewProp_ScreenMesaageClass_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABattleBlasterGameMode_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABattleBlasterGameMode_Statics::NewProp_ScreenMesaageClass,
...
struct Z_CompiledInDeferFile_FID_BattleBlaster_Source_BattleBlaster_BattleBlasterGameMode_h__Script_BattleBlaster_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ABattleBlasterGameMode, ABattleBlasterGameMode::StaticClass, TEXT("ABattleBlasterGameMode"), &Z_Registration_Info_UClass_ABattleBlasterGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABattleBlasterGameMode), 1253175554U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BattleBlaster_Source_BattleBlaster_BattleBlasterGameMode_h__Script_BattleBlaster_1570291167(TEXT("/Script/BattleBlaster"),
